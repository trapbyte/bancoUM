  ...
  return (
    <nav className={`w-full fixed top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 border-b border-gray-200 backdrop-blur-xl py-4' : 'bg-transparent backdrop-blur-sm py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex justify-between items-center">
        ...
        <div>
            <Link href="/login" className="px-6 py-2.5 bg-[#7C3AED] hover:bg-[#682ad8] text-white font-bold text-sm rounded-full transition-all shadow-[0_4px_15px_rgba(124,58,237,0.3)] hover:shadow-[0_0_25px_rgba(124,58,237,0.5)]">
                Banca en Línea
            </Link>
        </div>
      </div>
